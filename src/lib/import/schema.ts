...
export const COLUMNS = {
  ...
  costo_mo: { label: "Costo mano de obra", required: false, hint: "En la moneda de la instalación" },
  costo_repuestos: { label: "Costo repuestos", required: false, hint: "En la moneda de la instalación" },
} as const;
